...
const THUMBS: Thumb[] = [
  {
    src: "/images/gear/four-chariots-horse-emblem-mug-glossy-ceramic-coffee-mug-11oz-15oz.webp",
    alt: "View 1",
  },
  {
  ...
  {
    src: "/images/gear/four-chariots-horse-emblem-mug-glossy-ceramic-coffee-mug-11oz-15oz (2).webp",
    alt: "View 3",
  },
  {
    src: "/images/gear/four-chariots-horse-emblem-mug-glossy-ceramic-coffee-mug-11oz-15oz (3).webp",
    alt: "View 4",
  },
];
...
const SIZES: SizeOption[] = [
  { size: "11oz", price: 1500 },
  { size: "15oz", price: 1800 },
];

export function MugPdp() {
  ...
  const handleNotify = () => {
    open({
      productId: "fc-horse-emblem-mug",
      productName: "Horse Emblem Mug",
      variant: selectedSize.size,
    });
  };

  const active = THUMBS[activeIdx];
  const priceLabel = "$" + (selectedSize.price / 100).toFixed(2);
  ...
  return (
    <div className="pdp">
      ...
      <div className="pdpInfo fade-up" style={{ transitionDelay: ".1s" }}>
        ...
        <div className="pdpPrice" id="pdpPrice">
          {priceLabel}
        </div>

        <p className="pdpDesc">
          A simple ceramic mug featuring the FOUR CHARIOTS horse emblem. Glossy
          white ceramic gives the design strong contrast while keeping the look
          clean and minimal. Durable printing holds up through daily use,
          whether it&apos;s morning coffee, tea, or something warm at the end
          of the day.
        </p>
        <p className="pdpDesc">
          Made to be practical, steady, and easy to use. Nothing overdesigned.
          Just a solid everyday mug.
        </p>
        <p className="pdpDesc" style={{ marginTop: 14 }}>
          ...
          <br />
          Microwave-safe · Dishwasher-safe · Glossy white ceramic · Comfortable
          C-handle · Lead- and BPA-free
        </p>
        ...
        <div className="optionGroup">
          <div className="optionLabel">
            Size{" "}
            <span className="chosen" id="sizeChosen">
              {selectedSize.size}
            </span>
          </div>
          <div className="sizePills">
            {SIZES.map((s) => (
              <button
                ...
                type="button"
                className={
                  "sizePill" + (selectedSize.size === s.size ? " active" : "")
                }
